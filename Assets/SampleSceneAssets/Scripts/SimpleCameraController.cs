...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            // this used to be: scaleVector2(x=15, y=15)
            lookAction.AddBinding("<Gamepad>/rightStick").WithProcessor("scaleVector2(x=1, y=1)");
            ...
            // this used to be: scaleVector2(x=1, y=4)
            boostFactorAction.AddBinding("<Gamepad>/Dpad").WithProcessor("scaleVector2(x=0.5, y=2)");
        ...
        void Update()
        {
            ...
            // this used to be: 2.0f
            translation *= Mathf.Pow(1.0f, boost);
